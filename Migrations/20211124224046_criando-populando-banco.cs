...
{
    public partial class criandopopulandobanco : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomePessoa = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EmailPessoa = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Retorno = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoPessoa = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FotoPessoa = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, true, "images/funcionarios/chef-4.jpg", "John Gustavo", (byte)1, "I am ambitious workaholic, but apart from that, pretty simple person." },
                    { 2, 2, true, "images/funcionarios/chef-2.jpg", "Michelle Fraulen", (byte)2, "I am ambitious workaholic, but apart from that, pretty simple person." },
                    { 3, 3, true, "images/funcionarios/chef-3.jpg", "Alfred Smith", (byte)3, "I am ambitious workaholic, but apart from that, pretty simple person." },
                    { 4, 3, true, "images/funcionarios/chef-1.jpg", "Antonio Santibanez", (byte)4, "I am ambitious workaholic, but apart from that, pretty simple person." }
                });
